...
interface RecipientStatus {
  recipientId: string
  recipientType: 'client' | 'prospect' | 'user'
  recipientInfo: {
    nom: string
    prenom: string
    email?: string
...
interface SICInvitationProgressModalProps {
  isOpen: boolean
  onClose: () => void
...
export default function SICInvitationProgressModal({ 
  isOpen, 
  onClose, 
  recipients: initialRecipients,
  onStatusUpdate 
}: SICInvitationProgressModalProps) {
      ...
      >
        <DialogHeader className="flex-shrink-0 px-6 pt-6 pb-4">
          <DialogTitle className="text-2xl flex items-center gap-2">
            ...
            Suivi d'envoi des invitations SIC
          </DialogTitle>
          <DialogDescription>
